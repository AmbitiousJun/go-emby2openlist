  ...
  return (
    <div className="w-full px-6 lg:px-48 pb-12 space-y-6">
      ...
      <div className="flex flex-wrap gap-2 items-center justify-center">
        <a
          href="https://github.com/AmbitiousJun/go-emby2openlist/tree/v2.8.2"
          target="_blank"
        >
        ...
        <a
          ...
          target="_blank"
        >
          <img src="https://img.shields.io/docker/image-size/ambitiousjun/go-emby2openlist/v2.8.2"></img>
        </a>
        <a
          href="https://hub.docker.com/r/ambitiousjun/go-emby2openlist/tags"
          target="_blank"
...
const resources = [
  ...
  {
    href: "https://github.com/AmbitiousJun/go-emby2openlist/blob/v2.8.2/config-example.yml",
    text: "示例配置",
    icon: <Cog />,
  },
];
